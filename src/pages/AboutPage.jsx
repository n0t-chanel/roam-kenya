    ...
    <div className="bg-[#FDFCFB] min-h-screen text-gray-900 font-sans selection:bg-[#C5A059] selection:text-white overflow-hidden">
      ...
      <section className="pt-40 pb-24 relative overflow-hidden flex items-center min-h-[60vh]">
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Light Frosted Gradient */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#FDFCFB] via-[#FDFCFB]/90 to-transparent" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-[#C5A059]/5 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.1] mb-8 font-serif text-gray-900">
            Driven by <br /> 
            <span className="italic text-[#C5A059] font-light">Integrity.</span>
          </h1>
          <p className="max-w-xl text-gray-600 font-light text-base md:text-xl leading-relaxed border-l-2 border-gray-300 pl-6">
      ...
      {/* 2. OUR STORY (Crisp Whites & Soft Shadows) */}
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32">
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                Born in Nairobi,<br/>
                <span className="text-gray-400">Serving the World.</span>
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 pt-6">
                {stats.map((stat, i) => (
                  <div key={i} className="bg-white border border-gray-100 p-6 rounded-2xl hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] hover:border-[#C5A059]/30 transition-all duration-500 group">
                    <h3 className="text-3xl font-bold text-gray-900 group-hover:text-[#C5A059] transition-colors mb-1">{stat.value}</h3>
          ...
          <div className="max-w-5xl mx-auto bg-white border border-gray-100 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden group hover:border-[#C5A059]/30 transition-colors duration-700">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-[#B35A38]/5 rounded-full blur-[80px] pointer-events-none" />
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-8 font-serif">We reimagine the way <br className="hidden md:block"/>East Africa moves.</h2>
            <p className="text-gray-600 leading-relaxed font-light text-base md:text-lg mb-12 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
              {[
                ...
                <div key={i} className="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100 hover:bg-white hover:shadow-sm transition-all">
                  <Check size={16} className="text-[#C5A059]" />
                  <span className="text-xs font-bold tracking-wide text-gray-800 uppercase">{item}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 bg-white border-y border-gray-100 px-6 relative">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
          <div className="space-y-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-12 text-gray-900">Seamless Booking</h2>
            ...
            <div className="relative space-y-12">
              ...
              {[
                ...
                <div key={i} className="relative pl-14 group">
                  <div className="absolute left-0 top-1 w-8 h-8 rounded-full border border-[#C5A059] bg-white z-10 flex items-center justify-center text-[10px] text-[#C5A059] font-bold group-hover:bg-[#C5A059] group-hover:text-white transition-colors duration-500 shadow-sm">
                    0{i + 1}
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-[#C5A059] transition-colors">{step.title}</h3>
            ...
            <div className="pt-6">
              <button 
                ...
                className="bg-white border border-gray-200 text-gray-900 px-8 py-4 rounded-xl font-bold hover:border-[#C5A059] hover:bg-[#C5A059] hover:text-white transition-all flex items-center gap-3 text-sm group shadow-sm"
              >
          ...
          <div className="relative group">
            <div className="relative w-full aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-[3rem] overflow-hidden border border-gray-200 shadow-xl">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-white/80 via-transparent to-transparent" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900">Our Executive Fleet</h2>
            </div>
            <p className="text-gray-500 text-xs uppercase tracking-widest font-bold border-l border-gray-300 pl-4 py-1">Maintained to <br/>absolute perfection</p>
          </div>
      ...
      {/* 5. DRIVER CAREERS (Frosted Cinematic) */}
      <section id="careers" className="relative py-32 px-6 overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#FDFCFB] via-white/80 to-[#FDFCFB]" />
        </div>

        <div className="max-w-5xl mx-auto relative z-10 w-full bg-white/90 backdrop-blur-xl border border-white rounded-[3rem] p-10 md:p-16 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] overflow-hidden group hover:border-[#C5A059]/30 transition-colors duration-700">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#C5A059]/5 rounded-full blur-[100px] pointer-events-none group-hover:bg-[#C5A059]/15 transition-colors duration-1000" />
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center relative z-20">
            <div className="flex-1">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-serif">Chauffeur Careers</h2>
              <p className="text-gray-600 font-light mb-8 max-w-md">We are always looking for highly disciplined, well-spoken, and experienced professionals to join our roster.</p>
              ...
              <button 
                ...
                className="bg-[#C5A059] text-white px-8 py-4 rounded-xl font-bold hover:bg-gray-900 transition-all flex items-center justify-center gap-3 text-xs uppercase tracking-widest shadow-[0_10px_30px_rgba(197,160,89,0.3)]"
              >
            ...
            <div className="hidden lg:block flex-1 text-right">
               <ShieldCheck size={180} className="text-gray-100 ml-auto drop-shadow-sm" strokeWidth={1} />
            </div>
          </div>
        </div>
      </section>
...
// Light Theme Fleet Card Component
function FleetCard({ title, img, pax, bags, fallback }) {
  return (
    <div className="bg-white p-4 rounded-[2.5rem] border border-gray-100 group hover:border-[#C5A059]/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
      <div className="h-64 rounded-[2rem] overflow-hidden mb-6 relative bg-gray-100">
        <img 
          src={img} 
          alt={title}
      ...
      <div className="px-4 pb-4 relative">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-[#C5A059] transition-colors">{title}</h3>
        
        <div className="flex gap-6 border-t border-gray-100 pt-4">
          <div className="flex items-center gap-2 text-gray-500 font-semibold text-[10px] uppercase tracking-widest">
